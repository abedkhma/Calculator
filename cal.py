...
button_mul = Button(root, text="*", padx=41, pady=20, command=button_mulF)
button_sub = Button(root, text="-", padx=40, pady=20, command=button_subF)
button_div = Button(root, text="/", padx=43, pady=20, command=button_divF)
